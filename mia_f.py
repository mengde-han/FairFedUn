...
def args_parser():
    ...
    parser.add_argument('--dataroot', type=str, default="../data/FashionMNIST",
                        metavar='PATH',
...
if __name__ == '__main__':
    ...
    #     path = F"infattack_10/resnet-shadow_model_{i}_f.pt"
    ...
    # xpath = f"infattack_10/resnet_attack_x_{args.unlearning_class}_f.pt"
    # ypath = f"infattack_10/resnet_attack_y_{args.unlearning_class}_f.pt"
    # torch.save(tensor_x, xpath)
    # torch.save(tensor_y, ypath)

    # Load datasets
    tensor_x = torch.load(f"infattack_10/resnet_attack_x_{args.unlearning_class}_f.pt")
    tensor_y = torch.load(f"infattack_10/resnet_attack_y_{args.unlearning_class}_f.pt")
    ...
    # # Save attack model
    # path = F"infattack_10/resnet_attack_model_{args.unlearning_class}_f.pt"
...
#################################################################
    ...
    # #save
    # for fusion_key in fusion_types:
    #     path = F"infattack_10/net_glob_{fusion_key}_f.pt" 
    ...
    # path = F"infattack_10/party_models_dict_f.pt" 
